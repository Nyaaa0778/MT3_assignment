...
const char kWindowTitle[] = "LE2B_27_ヤマダ_ナオ_4_2_確認課題";
...
void DrawPendulum(const Ball &ball, const Pendulum &pendulum,
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
  ...
  while (Novice::ProcessMessage() == 0) {
    ...
    DrawPendulum(ball, pendulum, worldViewProjectionMatrix, viewportMatrix);
